...
SDKVERSION="10.2"
LIB_PATH="vo-aacenc-0.1.3"
#ARCHS="armv7 armv7s i386"
ARCHS="i386 x86_64 armv7s armv7"
OUTPUTDIR="../output/libvo_aacenc"
...
export CPPFLAGS="${MIN_VERSION_FLAG} -arch ${ARCH} -I${PLATFORM_SDK}/usr/include"
...
cp -r ${OUTPUTDIR}/universal/include/ /usr/local/include
